...
import com.food_frenzy.LoginCredentials.UserLogin;
import com.food_frenzy.count.Logic;
...
public class AdminController {
	...
	public String userLogin( @ModelAttribute("userLogin") UserLogin login,Model model)
	{
		...
		if(services.validateLoginCredentials(email, password))
		{
			...
			List<Order> orders = this.orderServices.getOrdersForUser(user);
	...
	public String returnBack(Model model)
	{
		...
		List<Order> orders = this.orderServices.getOrders();
	...
	public String orderHandler(@ModelAttribute() Order order,Model model)
	{
